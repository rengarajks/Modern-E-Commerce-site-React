...
const ProductPage = () => {
  ...
  return (
    product && (
      <div className="h-screen bg-clone-background">
        <div className="min-w-[1000px] max-w-[1500px] m-auto p-4">
          <div className="grid grid-cols-10 gap-2">
            ...
            <div className="col-span-2 p-4 rounded bg-white">
              ...
              <div className="text-sm xl:text-base text-green-500 font-semibold mt-3">
                FREE Returns
              </div>
              <div className="text-sm xl:text-base text-green-500 font-semibold mt-1">
                FREE Delivery
              </div>
